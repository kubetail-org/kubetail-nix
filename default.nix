...
pkgs.buildGoModule rec {
  ...
  src = pkgs.fetchurl {
    url = "https://github.com/kubetail-org/kubetail/releases/download/cli%2Fv${version}/kubetail_${version}.orig.tar.xz";
    hash = "sha256-nb3XL8tyM0B97iDDxHaanCwl1PWOEsP8aFPzL86SWK0=";
  };
